...
class SwitchButton(QWidget):
    ...
    def __init__(self, parent=None, VideoPattern=False):
        ...
        self.resize(80, 35)
        self.state = VideoPattern  # 按钮状态：True表示开，False表示关
...
class DayTrain(object):
    ...
    def ShowNNTable(self):
        ...
        self.Widget1.Start(self.Timing,self.VideoPattern)

    def ShowRandomPe(self):
        self.Widget2.frame.setVisible(True)
        self.frame.setVisible(False)
        print("self.Widget2.Start(self.Timing,self.VideoPattern)")
        self.Widget2.Start(self.Timing,self.VideoPattern)
    ...
    def ShowDialog(self):
        ...
        self.label2.setText("手势识别模式")
        self.label2.setObjectName('label1')
        self.label2.setGeometry(QtCore.QRect(20, 130, 120, 80))
        self.ExdialogWidget.setStyleSheet("QLabel#label1{font-size:20px}")
        self.switchButton = SwitchButton(self.ExdialogWidget,self.VideoPattern)
        self.switchButton.setGeometry(QtCore.QRect(200, 150, 80, 35))
        self.switchButton.checkedChanged.connect(self.getState)
