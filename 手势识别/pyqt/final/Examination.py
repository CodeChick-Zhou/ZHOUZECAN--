...
class Examination(object):
    ...
    def ExamQuestion(self):
        ...
        while count:
            ...
            # 消除重复题目
            for m in range(0,len(self.NEQuestion)):
                if (self.NEQuestion[m][0] == cur[0]) & (self.NEQuestion[m][1] == cur[1]) & (self.NEQuestion[m][2] == cur[2]) & (self.NEQuestion[m][3] == cur[3]) & (self.NEQuestion[m][4] == cur[4]):
                    print("*********************************************************")
                    print("self.NEQuestion[m]",self.NEQuestion[m])
                    print("cur", cur)
