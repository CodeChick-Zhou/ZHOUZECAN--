...
class Random_Practice(object):
    ...
    def Multiplicationfun(self):
        ...
        print("Random_Start self.lst",self.lst)
    ...
    def Addfun(self):
        ...
        # [] + [1] = [2][3]
        if self.addRandom == 0:
            self.OnlyReadlst = [False, True, True, True]
            # self.right_Number_LineEdit_2.setReadOnly(True)
            # self.right_Number_LineEdit_3.setReadOnly(True)
            # self.right_Number_LineEdit_4.setReadOnly(True)
            self.SetReadOnly(self.right_Number_LineEdit_2,True)
        ...
        # [1] + [] = [2][3]
            ...
            self.OnlyReadlst = [True, False, True, True]
            # self.right_Number_LineEdit_1.setReadOnly(True)
            # self.right_Number_LineEdit_3.setReadOnly(True)
            # self.right_Number_LineEdit_4.setReadOnly(True)
            self.SetReadOnly(self.right_Number_LineEdit_1,True)
    ...
    def Minusfun(self):
        ...
        # [1] - [2] = []
            ...
            self.OnlyReadlst = [True, True, False, True]
            # self.right_Number_LineEdit_1.setReadOnly(True)
            # self.right_Number_LineEdit_2.setReadOnly(True)
            self.SetReadOnly(self.right_Number_LineEdit_1, True)
            self.SetReadOnly(self.right_Number_LineEdit_2, True)
    ...
    def Start(self,time,VideoPattern):
        ...
        print("random VideoFlag",self.VideoFlag)
        if self.VideoFlag:
    ...
    def GetTipsValueAdd(self):
        ...
        # [] + [1] = [2][3]
        if self.addRandom == 0:
            tip1 = "该等式不成立，正确的答案为" + str(self.firstleftvalue)+"+"+str(self.secondleftvalue)+"="+str(self.addrightvalue)
        ...
        # [1] + [2] = [][]
            ...
            if self.addrightvalue <= 9:
                ...
                tip1 = "该等式不成立，正确的答案为" + str(self.firstleftvalue)+"+"+str(self.secondleftvalue)+"="+str(self.firstrightvalue)
                tip2 = "请对着摄像头的红框摆出一个酷酷的手势" + str(self.firstrightvalue)
                self.right_Number_LineEdit_5.setText(tip1)
                self.right_Number_LineEdit_6.setText(tip2)
            else:
                ...
                tip1 = "该等式不成立，正确的答案为" + str(self.firstleftvalue)+"+"+str(self.secondleftvalue)+"="+str(self.firstrightvalue) + str(self.secondrightvalue)
                tip2 = "请对着摄像头的红框摆出第一个酷酷的手势" + str(self.firstrightvalue)
                self.right_Number_LineEdit_5.setText(tip1)
                self.right_Number_LineEdit_6.setText(tip2)
    ...
    def GetArrayLineEditRead(self):
        print("GetArrayLineEditRead Start")
        ...
        print("self.OnlyReadlst", self.OnlyReadlst)
